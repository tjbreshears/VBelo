...
games = []
with open("../../inputs/Tournaments/Tournaments - MPSF.csv", 'r') as data:
    for line in csv.DictReader(data):
        games.append(line)
...
def elorating(game, K, t):
    ...
    global seed2_semis, seed3_semis, seed4_semis, seed5_semis, seed6_semis, seed7_semis
...
# Match 2: 3 vs 6 (quarterfinals)
#    if game['date'] == '2' and random_outcome < p1:
#        if games[4]['t1'] == seed2:
#            games[4]['t2'] = game['t1']
#        elif games[3]['t2'] == seed7:
#            games[4]['t1'] = game['t1']
#        seed3_semis += 1
...
# Match 3: 4 vs 5 (quarterfinals)
#    if game['date'] == '3' and random_outcome < p1:
#        if games[4]['t1'] == seed2 and games[4]['t2'] == seed3:
#            games[3]['t2'] = game['t1']
#        elif games[4]['t1'] == seed3 and games[3]['t2'] == seed7:
#            games[4]['t2'] = game['t1']
#        elif games[4]['t1'] == seed2 and games[3]['t2'] == seed6:
#            games[4]['t2'] = game['t1']
#        elif games[4]['t2'] == seed6 and games[3]['t2'] == seed7:
#            games[4]['t2'] = game['t1']
#        seed4_semis += 1
...
# Match 4: 1 vs 4/5/6/7 (semifinals)
...
# Match 5: 2/3/4/5 vs 3/4/5/6 (semifinals)
...
# Match 6: 1/4/5/6/7 vs 2/3/4/5/6 (finals)
...
# formatting for printing (the hard way)
    ...
    print("MPSF Tournament Projections")
