            ...
            for x in range(len(teams)):
                if games[i]['t1'] == teams[x]['short_name']:
                    ...
                    if int(teams[x]['away_wins'])+int(teams[x]['away_losses']) != 0:
                        teams[x]['away_pct'] = int(teams[x]['away_wins'])/(int(teams[x]['away_wins'])+int(teams[x]['away_losses']))
                ...
                if games[i]['t2'] == teams[x]['short_name']:
                    ...
                    if int(teams[x]['home_losses'])+int(teams[x]['home_wins']) != 0:
                        teams[x]['home_pct'] = int(teams[x]['home_wins'])/(int(teams[x]['home_losses'])+int(teams[x]['home_wins']))
